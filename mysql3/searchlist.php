...
<html lang="en">
  ...
  <div class="container">
    <h1>Family Member</h1>
    <p class="lead">We have <?php echo ($result->num_rows ? $result->num_rows : 0); ?> family member in our list.</p>
    <form role="form" method="GET" style="width: 500px;"action="searchlist.php">
